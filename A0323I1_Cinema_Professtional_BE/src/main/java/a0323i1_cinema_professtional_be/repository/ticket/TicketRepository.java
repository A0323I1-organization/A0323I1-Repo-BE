...
public interface TicketRepository extends JpaRepository<Ticket,Integer> {
    ...
    void createTicket(@Param("invoiceId") int invoiceId, @Param("seatId") String seatId);


    @Query("select distinct m.movieName as movieName , st.movieTime as movieTime, st.showDate as showDate, c.fullname as fullname," +
            " c.email as email , c.phone as phone from Customer as c" +
    ...
    TicketDetailDTO getTicketDetail(@Param("invoiceId") int invoiceId);
