...
public interface EmployeeRepository extends JpaRepository<Employee,Integer> {
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO employee (address,birth_day, gender, fullname, id_card, email, phone, employe_image, employee_account_id) " +
            "VALUES (?,?, ?, ?, ?, ?, ?,?, ?)", nativeQuery = true)
    void createEmployee(@Param("address")String address,@Param("birthday") Date birthday, @Param("gender") boolean gender, @Param("fullname") String fullname,
                        @Param("idCard") String idCard, @Param("email") String email,
                        @Param("phone") String phone, @Param("employeeImage") String employeeImage, @Param("accountId") int accountId);
    @Modifying
    @Transactional
